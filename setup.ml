...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74645d0b5b3c384411a5fdc055df16fc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Sierra Chart SCID files parser for OCaml";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "scid"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "copy.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "},\250P\b1\171L\r\005\162\020[+\183u";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
